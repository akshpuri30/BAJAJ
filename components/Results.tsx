  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {(data.invalidList.length > 0 || data.duplicateList.length > 0) && (
          <motion.div variants={item} className="neo-container p-5 col-span-2 sm:col-span-1 flex items-center justify-between bg-danger/5 border-danger/20">
            <div>
              ...
              <p className="text-3xl font-extrabold text-danger">{data.invalidList.length + data.duplicateList.length}</p>
            </div>
      ...
      {/* Warnings & Issues */}
      <AnimatePresence>
        {(data.duplicateList.length > 0 || data.invalidList.length > 0) && (
